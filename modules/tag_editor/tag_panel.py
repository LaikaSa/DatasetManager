...
class FilterTab(QWidget):
    filter_changed = Signal(set, str, str)  # tags, combine_logic, filter_logic
    ...
    def clear_filters(self):
        ...
        self.tag_list.clear_all_checks()  # Clear checkbox states
    ...
    def filter_tag_list(self, text):
        # To be implemented when connected to tag list
        pass
...
class TagList(QScrollArea):
    ...
    def clear_all_checks(self):
        """Uncheck all checkboxes without emitting signals"""
...
class TagPanel(QWidget):
    ...
    def init_ui(self):
        ...
        # Filter tab (pass tag_list reference)
        ...
        # Add tag list and connect signals
    ...
    def on_tag_toggled(self, tag: str, checked: bool):
        if checked:
            self.filter_tab.selected_tags.add(tag)
        else:
            self.filter_tab.selected_tags.discard(tag)
